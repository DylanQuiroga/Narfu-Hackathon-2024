...
const char* serverName = "http://192.168.180.47:3000/insertar_datos"; // URL del servidor, en este caso, un servidor local
...
void loop() {
  ...
  // Verificar si hubo un error en la lectura del DHT22
